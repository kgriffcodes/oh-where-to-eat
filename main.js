...
function randomRestaurant(e) {
  ...
  switch (choice) {
    ...
    case 4:
      ...
      foodDetails = "Tonight might be the night for some Chinese takeout.";
    ...
    case 7:
      ...
      foodDetails = "Let's be honest Fast food could hit the spot right now.";
    ...
    case 12:
      ...
      foodDetails = "No matter the hour, it's breakfast o'clock somewhere!";
